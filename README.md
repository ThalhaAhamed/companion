...
| Symptom | Cause | Fix |
|---|---|---|
| Agent can't look anything up in a call | MeetStream cannot reach your server | Tunnel or domain in **Settings → Meetings → Public address**; the next launch re-points the agent |
